    ...
    $password2 = strip_tags($_POST['reg_password2']); //remove html tag
	 ...
	 if($em == $em2){
	 	...
	 	if(filter_var($em, FILTER_VALIDATE_EMAIL)){
             ...
             if($num_rows > 0){
               array_push($error_array, "Email already in use<br>") ; //$error_array est un variable dont il ya plusieurs valeur 
             }
    ...
    if($password != $password2){
     ...
     if(empty($error_array)){
      ...
      $profile_pic = "assets/images/profilePics/deafultPP.png";
       ...
       //nettoyer les variables de session après une inscription réussie est une bonne pratique de sécurité et de gestion des données pour garantir une expérience utilisateur sûre et cohérente.
     }
}
?>